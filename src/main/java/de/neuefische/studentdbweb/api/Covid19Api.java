...
public class Covid19Api {
    ...
    public int numberOfActiveInfections() {
        ...
        ResponseEntity<CovidApiCountryStats[]> responseEntity = restTemplate1.getForEntity(url, CovidApiCountryStats[].class);
        ...
        throw new IllegalStateException("Could not get data from Covid19 API");
    }
}
